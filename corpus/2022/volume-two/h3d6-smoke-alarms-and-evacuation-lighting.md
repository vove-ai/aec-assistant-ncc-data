---
clause: H3D6
title: Smoke alarms and evacuation lighting
citation: NCC 2022 V2 H3D6
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-two/h-class-1-and-10-buildings/part-h3-fire-safety#H3D6
edition: "2022"
volume: volume-two
jurisdiction: aus
supersedes: "2019: 3.7.5"
...
> **Info — Smoke alarms general requirements**
>
> Performance Requirement H3P2 and the Deemed-to-Satisfy Provisions of Part 9.5 of the ABCB Housing Provisions require automatic warning on the detection of smoke in buildings, so that occupants may be alerted to a fire in order to evacuate to a place of safety.

> **Info — Different smoke alarm requirements for Class 1a and Class 1b buildings**
>
...
> **Info — Smoke alarms complying with AS 3786**
>
...
> **Info — Smoke alarms to be connected to consumer mains source**
>
...
> **Info — Interconnection of smoke alarms**
>
...
> **Info — Smoke alarms required on other storeys not containing bedrooms**
>
...
> **Info — Added flexibility when considering smoke alarm location**
>
