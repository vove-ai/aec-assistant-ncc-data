---
clause: C1V1
title: Determination of sanitary plumbing wastewater flowrates
citation: NCC 2022 V3 C1V1
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-three/c-sanitary-plumbing-and-drainage-systems/part-c1-sanitary-plumbing-systems#C1V1
edition: "2022"
volume: volume-three
jurisdiction: aus
...
(a) QTotal = the probable simultaneous wastewater flowrate for that pipework section (l/s); and
(b) QOther = the sum of any other wastewater flowrates such as pumped discharges (l/s); and
(c) K = the frequency factor given in Table C1V1a (dimensionless); and
(d) ∑DU = the sum of the discharge units as given in Table C1V1b, connected upstream of that pipework section (dimensionless).
