---
clause: D2D18
title: Number of persons accommodated
citation: NCC 2022 V1 D2D18
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-one/d-access-and-egress/part-d2-provision-escape#D2D18
edition: "2022"
volume: volume-one
jurisdiction: aus
supersedes: "2019: D1.13"
...
**(1)** For the purposes of the Deemed-to-Satisfy Provisions, the number of persons accommodated in a storey, room or mezzanine must be determined with consideration to the purpose for which it is used and the layout of the floor area by—

(a) calculating the sum of the numbers obtained by dividing the floor area of each part of the storey by the number of square metres per person listed in Table D2D18 according to the use of that part, excluding spaces set aside for—
