---
clause: J6D5
title: Fans and duct systems
citation: NCC 2022 V1 J6D5
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-one/j-energy-efficiency/part-j6-air-conditioning-and-ventilation#J6D5
edition: "2022"
volume: volume-one
jurisdiction: aus
supersedes: "2019: J5.4"
...
η_(min)=0.13×ln(p)−0.3

(b) In the formula at (a)—
  (a) η_(min) = the minimum required system static efficiency for installation type A or C or the minimum required system total efficiency installation type B or D; and
  (b) p = the static pressure of the system (Pa); and
...
η_(min)=0.85×(a×ln(P)−b+N)/100

(d) In the formula at (c)—
  (i) η_(min) = the minimum required system static efficiency for installation type A or C or the minimum required system total efficiency installation type B or D; and
