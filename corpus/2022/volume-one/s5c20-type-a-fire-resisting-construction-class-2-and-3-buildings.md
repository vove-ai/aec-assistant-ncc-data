...
citation: NCC 2022 V1 S5C20
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-one/c-fire-resistance/5-fire-resisting-construction#S5C20
edition: "2022"
volume: volume-one
jurisdiction: aus
supersedes: "2019: Spec C1.1: 3.10"
...
(b) the lowest storey is constructed of concrete or masonry including the floor between it and the Class 2 or 3 part of the building above; and
(c) the lowest storey and the storey above are separated by construction having an FRL of not less than 90/90/90 with no openings or penetrations that would reduce the fire-resisting performance of that construction except that a doorway in that construction may be protected by a –/60/30 self-closing fire door.
...
(a) for any floor and any loadbearing wall, may be reduced to 60, except any FRL criterion of 90 for an external wall must be maintained when tested from the outside; and
