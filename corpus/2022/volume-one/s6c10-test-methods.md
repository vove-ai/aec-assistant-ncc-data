...
clause: S6C10
title: Test methods
citation: NCC 2022 V1 S6C10
web_url: https://ncc.abcb.gov.au/editions/ncc-2022/adopted/volume-one/c-fire-resistance/6-structural-tests-lightweight-construction#S6C10
edition: "2022"
volume: volume-one
jurisdiction: aus
supersedes: "2019: Spec C1.8: 5"
building_classes_excluded: Class 1a, Class 1b, Class 10a, Class 10b, Class 10c
---

# S6C10 — Test methods

**(1)** Tests must be carried out in accordance with the following:

(a) Material tests — The methods specified for the constituent materials of the construction of the standards adopted by reference in the NCC.
...
(c) For resistance to impact — The provisions for testing wall systems in ASTM E695-03, except that—
  ...
  (ii) the impact bag must be not less than 225 mm in diameter and not more than 260 mm in diameter and have a mass of not less than 27.2 kg or more than 27.3 kg; and
