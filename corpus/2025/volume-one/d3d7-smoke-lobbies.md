...
clause: D3D7
title: Smoke lobbies
citation: NCC 2025 V1 D3D7
web_url: https://ncc.abcb.gov.au/editions/ncc-2025/adopted/volume-one/d-access-and-egress/part-d3-construction-exits#D3D7
edition: "2025"
volume: volume-one
jurisdiction: aus
...
(c) at any opening from the occupied areas, have smoke doors complying with S12C3 and S12C4 except that the smoke sensing device need only be located on the approach side of the opening; and
(d) be pressurised as part of the exit if the exit is required to be pressurised under E2D4.
