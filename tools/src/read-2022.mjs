...
export const BASE_VIEW_NOTE = `${BASE_VIEW_NOTE_TOKEN} part of the text below was kept from a container the `
  ...
  + "the published text prints it; and the WORDING is the draft author's re-typing of the NCC 2022 text, "
  ...
  + 'quote the words rather than a sub-paragraph letter, and check anything you rely on against the '
  + 'published text at `web_url`.';
